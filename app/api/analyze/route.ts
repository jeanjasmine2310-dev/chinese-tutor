...
- 문법 설명 안에 나오는 모든 중국어 단어에 병음 필수
- 예시 형식:
  ### 1. 可能 (kěnéng) vs 应该 (yīnggāi)
  - 可能 (kěnéng) = 가능성 낮음 (~일 수도)
  - 应该 (yīnggāi) = 가능성 높음 (~일 것이다)
  - 예: 他可能来 (tā kěnéng lái) - 그가 올 수도 있다
  - 예: 他应该来 (tā yīnggāi lái) - 그는 올 것이다
